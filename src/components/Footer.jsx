...
const Footer = () => {
  return (
    <div className="mt-auto ">
      <div className="w-full py-6 flex items-center shadow-lg justify-center  bg-[black]">
        <div className="md:w-2/3 w-full px-4 text-white flex flex-col">
          <div className="w-full  font-bold">
            <div className="flex   ">
              <div className="">
                <img
                  src="/logo.webp"
                  className=" rounded-lg shadow-lg  border bg-white border-white"
                  height={220}
                  width={220}
                  alt=""
                />
          ...
          <div className="flex mt-8 flex-col md:flex-row md:justify-between">
            <p className="w-full md:w-2/3 text-gray-400">
              The SP Events
              <br />
              #26/827 Siddeshwar Nagar Road, Hubballi- 580031 , Karnataka,
              India.
              <br />
              Phone No : +91 74118 63227 / +91 82962 91052
              <br />
              Contact Persons : Mr. Samarth U Patangi & Mukhesh S Havaldar
              <br />
              Email id : thespevents@gmail.com
              <br />
              GSTIN : 29FSUPP0565A1ZC
              <br />
              URN NO : UDYAM-KR-13-0030373
            </p>
            <div className="w-44 pt-6 md:pt-0">
              <Link
                to="contact"
                className="bg-[#ffa500] justify-center hover:scale-105 text-black cursor-pointer font-monst font-[500] text-center rounded-lg shadow px-10 py-2 transition-all duration-200 ease-in-out flex items-center"
          ...
          <div className="flex flex-col">
            <div className="flex mt-11 mb-7 md:flex-row justify-between flex-col">
              <div className="cursor-pointer">
                <p className=" font-nunito uppercase tracking-wider  md:text-3xl font-monst">
                  THE SP<span className="text-[#eab700]"> Events</span>
                </p>
              </div>
              ...
              <div className="flex flex-row space-x-8 items-center md:justify-between justify-around md:mt-0 mt-3">
                <a
                  href="
                  https://www.facebook.com/profile.php?id=100094578990941&mibextid=LQQJ4d"
                  className="cursor-pointer hover:scale-120 transition-all duration-200 ease-in-out border py-2 px-2 hover:border-[#ffa500]  rounded-md hover:animate-bounce hover:bg-[#ffa500]"
                ...
                <a
                  href="https://instagram.com/the_sp_events?igshid=MzRlODBiNWFlZA=="
                  className="cursor-pointer hover:scale-120 transition-all duration-200 ease-in-out border py-2 px-2 hover:border-[#ffa500]  rounded-md hover:animate-bounce hover:bg-[#ffa500]"
                  aria-describedby="hello"
                >
                  <svg
                ...
                <a
                  href="https://youtube.com/@TheSPEvents"
                  className="cursor-pointer hover:scale-120 transition-all duration-200 ease-in-out border py-2 px-2 hover:border-[#ffa500]  rounded-md hover:animate-bounce hover:bg-[#ffa500]"
                  aria-describedby="hello"
                >
                  <svg
                ...
                <a
                  href="https://www.linkedin.com/company/the-sp-events/"
                  className="cursor-pointer hover:scale-120 transition-all duration-200 ease-in-out border py-2 px-2 hover:border-[#ffa500]  rounded-md hover:animate-bounce hover:bg-[#ffa500]"
                  aria-describedby="hello"
                >
                  <svg
            ...
            <div className="w-full text-center  text-sm my-2 italic  text-gray-300">
              <a
                href="https://api.whatsapp.com/send?phone=919538513924&text=Hello%20"
                className="underline hover:text-white hover:scale-105"
              >
                <p className="w-full text-center  text-sm  italic  text-gray-300">
                  Designed And Developed By Mercy
                </p>
              </a>
            </div>
          </div>
